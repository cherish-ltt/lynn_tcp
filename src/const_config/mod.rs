...
pub(crate) static DEFAULT_IPV4: &str = "0.0.0.0:9177";
/// The maximum number of connections allowed by the server.
pub(crate) static DEFAULT_MAX_CONNECTIONS: usize = 1000;
/// The maximum number of threads allowed by the server.
pub(crate) static DEFAULT_MAX_THREADPOOL_SIZE: usize = 10;
/// The default maximum receive data size for a single client in bytes.
pub(crate) static DEFAULT_MAX_RECEIVE_BYTES_SIZE: usize = 1024;
...
pub(crate) static DEFAULT_CHANNEL_SIZE: usize = 3;
...
pub(crate) static DEFAULT_PROCESS_PERMIT_SIZE: usize = 7;
/// The interval for heartbeat detection in seconds.
pub(crate) static DEFAULT_CHECK_HEART_INTERVAL: u64 = 5;
/// The timeout time for heartbeat detection in seconds.
pub(crate) static DEFAULT_CHECK_HEART_TIMEOUT_TIME: u64 = 30;